...
bool manus_ros2_msgs__msg__manus_ergonomics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("manus_ros2_msgs.msg._manus_ergonomics.ManusErgonomics", full_classname_dest, 53) == 0);
  }
  manus_ros2_msgs__msg__ManusErgonomics * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of ManusErgonomics */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("manus_ros2_msgs.msg._manus_ergonomics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ManusErgonomics");
  ...
  manus_ros2_msgs__msg__ManusErgonomics * ros_message = (manus_ros2_msgs__msg__ManusErgonomics *)raw_ros_message;
  {  // type
    PyObject * field = NULL;
