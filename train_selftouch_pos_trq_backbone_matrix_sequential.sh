...
param_files=(
  parameter/selftouch_gru_attention/parameter_base/parameter_base.yaml
  parameter/selftouch_temporal_mixer/parameter_base/parameter_base.yaml
  parameter/selftouch_fcn/parameter_base/parameter_base.yaml
  parameter/selftouch_transformer/parameter_base/parameter_base.yaml
  parameter/selftouch_mamba/parameter_base/parameter_base.yaml
...
echo "Running ${#param_files[@]} pos+trq self-touch backbone sweeps sequentially with SWEEP_COUNT=${SWEEP_COUNT}"
...
echo
echo "All pos+trq self-touch backbone sweeps finished."
