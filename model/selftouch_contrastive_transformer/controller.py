"""
controller.py for selftouch_contrastive_transformer
...
from selftouch_contrastive_transformer import SelfTouchContrastiveTransformer
...
class RNN_controller(AbstractController):
    """Training + testing controller for selftouch_contrastive_transformer."""
    ...
    def train_controller(self, sweep: bool = False):
        ...
        self.model = SelfTouchContrastiveTransformer(self.model_param).to(self.device)
