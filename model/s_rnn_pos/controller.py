...
from s_rnn import ExternalTouchRNN
...
class RNN_controller(AbstractController):
        ...
        with torch.no_grad():
            for ts in range(200):
                if node_exec.ok():
                    ...
                    (_, jnt_cmd_pos_pred), self_touch, state = self.model.forward(
    ...
    def calc_loss_func(self,data,mode="train"):
        ...
        return (total_loss,loss_pos,loss_cmd),\
               (pos_preds,cmd_preds)
