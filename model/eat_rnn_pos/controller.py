...
from eat_rnn import ExternalTouchRNN
...
class RNN_controller(AbstractController):
    ...
    def test_controller(self):
        ...
        plot(norm(gt_idx), norm(pred_self_idx), "GT", "Self", "EAT-RNN: Index - Self Touch", "./log/eat_index_self.png")
        plot(norm(gt_thumb), norm(pred_self_thumb), "GT", "Self", "EAT-RNN: Thumb - Self Touch", "./log/eat_thumb_self.png")
        plot(norm(gt_idx), norm(pred_ext_idx), "GT", "External", "EAT-RNN: Index - External", "./log/eat_index_ext.png")
        plot(norm(gt_thumb), norm(pred_ext_thumb), "GT", "External", "EAT-RNN: Thumb - External", "./log/eat_thumb_ext.png")
        ...
        }).to_csv("./log/eat_timeseries.csv", index=False)
