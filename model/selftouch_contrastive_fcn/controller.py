"""
controller.py for selftouch_contrastive_fcn
...
from selftouch_contrastive_fcn import SelfTouchContrastiveFCN
...
class RNN_controller(AbstractController):
    """Training + testing controller for selftouch_contrastive_fcn."""
    ...
    def train_controller(self, sweep: bool = False):
        ...
        self.model = SelfTouchContrastiveFCN(self.model_param).to(self.device)
