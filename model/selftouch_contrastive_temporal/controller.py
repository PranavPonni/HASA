"""
controller.py for selftouch_contrastive_temporal
...
from selftouch_contrastive_temporal import SelfTouchContrastiveTemporal
...
class RNN_controller(AbstractController):
    """Training + testing controller for selftouch_contrastive_temporal."""
    ...
    def train_controller(self, sweep: bool = False):
        ...
        self.model = SelfTouchContrastiveTemporal(self.model_param).to(self.device)
