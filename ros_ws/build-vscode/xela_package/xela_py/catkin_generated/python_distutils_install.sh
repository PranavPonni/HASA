...
echo_and_run cd "/home/handlingteam2/HASA/ros_ws/src/xela_package/xela_py"
...
echo_and_run /usr/bin/env \
    ...
    "/home/handlingteam2/HASA/ros_ws/src/xela_package/xela_py/setup.py" \
     \
    build --build-base "/home/handlingteam2/HASA/ros_ws/build-vscode/xela_package/xela_py" \
    install \
    --root="${DESTDIR-/}" \
